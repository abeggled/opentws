...
def _register_builtin_dpts() -> None:
    defs = [
        ...
        DPTDefinition("DPT20.003", "Occupancy Mode",         "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.004", "Priority",               "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.005", "Light Application Mode", "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.006", "Application Area",       "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.007", "Alarm Class Type",       "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.008", "PSU Mode",               "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.011", "Error Class System",     "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.012", "Error Class HVAC",       "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.013", "Time Delay",             "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.014", "Beaufort Wind Scale",    "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.017", "Sensor Select",          "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.020", "Actuator Connect Type",  "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        ...
        DPTDefinition("DPT20.102", "HVAC Operating Mode",    "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        ...
        DPTDefinition("DPT20.105", "HVAC Controller Mode",   "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.106", "HVAC Emergency Mode",    "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.107", "Changeover Mode",        "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        ...
        DPTDefinition("DPT20.112", "Master/Slave Mode",      "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.113", "Status Room Setpoint",   "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.600", "Behaviour Lock/Unlock",  "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.601", "Behaviour Bus PowerUp",  "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.602", "DALI Fade Time",         "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.603", "Blinking Mode",          "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
        DPTDefinition("DPT20.604", "Light Control Mode",     "INTEGER", "", 1, _dpt20_encode, _dpt20_decode),
