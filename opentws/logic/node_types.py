...
BUILTIN_NODE_TYPES: list[NodeTypeDef] = [
    ...
    NodeTypeDef(
        ...
        config_schema={
            ...
            "value_formula":     {"type": "string",  "default": "",
                                  "label": "Formel (value = Rohwert)"},
            # ── Filter ────────────────────────────────────────────────────
            "trigger_on_change": {"type": "string",  "default": "",
                                  "enum": ["", "true"],
                                  "label": "Nur bei Wertänderung auslösen"},
            "min_delta":         {"type": "number",  "default": "",
                                  "label": "Mindeständerung (absolut)"},
            "min_delta_pct":     {"type": "number",  "default": "",
                                  "label": "Mindeständerung (%)"},
            "throttle_ms":       {"type": "number",  "default": "",
                                  "label": "Drosselung (ms)"},
        },
        color="#0f766e",
    ),
    NodeTypeDef(
        ...
        config_schema={
            ...
            # ── Transformation ────────────────────────────────────────────
            "value_formula":   {"type": "string",  "default": "",
                                "label": "Formel (value = Eingang)"},
            # ── Filter ────────────────────────────────────────────────────
            "only_on_change":  {"type": "string",  "default": "",
                                "enum": ["", "true"],
                                "label": "Nur bei Wertänderung schreiben"},
            "min_delta":       {"type": "number",  "default": "",
                                "label": "Mindeständerung (absolut)"},
            "throttle_ms":     {"type": "number",  "default": "",
                                "label": "Drosselung (ms)"},
