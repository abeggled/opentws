...
from opentws.models.datapoint import DataPoint, DataPointCreate, DataPointUpdate
...
class DataPointRegistry:
    ...
    def __init__(self, db: Any, mqtt_client: Any, event_bus: Any) -> None:
        ...
        from opentws.core.mqtt_client import MqttClient
    ...
    async def handle_value_event(self, event: Any) -> None:
        ...
        from opentws.core.event_bus import DataValueEvent  # avoid circular at module level
